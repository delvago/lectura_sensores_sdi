 ...
 ********************************************************/
double lectura_temperatura_suelo_teros(String sensor){
 ...
 return entero_temperatura_sensor;  
}
 /*********************************************************
 ...
 * la función getValue para funcionar
 ********************************************************/
double lectura_humedad_suelo_teros(String sensor){
  String myCommand = sensor + "R0!";
  mySDI12.sendCommand(myCommand);
  delay(300);
  String respuesta_sensor = "";
 ...
 * la función getValue para funcionar
 ********************************************************/
double lectura_temperatura_suelo_echo(String sensor){
  String myCommand = sensor + "R0!";
  mySDI12.sendCommand(myCommand);
  delay(300);
  String respuesta_sensor = "";
 ...
 * la función getValue para funcionar
 ********************************************************/
 double lectura_humedad_suelo_echo(String sensor){
  String myCommand = sensor + "R0!";
  mySDI12.sendCommand(myCommand);
  delay(300);
  String respuesta_sensor = "";
